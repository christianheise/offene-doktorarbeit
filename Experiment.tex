...
Um vor allem die Kriterien und Argumente (zum Beispiel Auwand) für oder gegen das offene Publizieren prüfen zu können und Handlungsempfehlungen für das offene Schreiben von Dissertationen erstellen zu können, wurde für diese Arbeit als Selbstexperiment selber eine offene Schreibweise gewählt. Dabei wurde die Arbeit direkt und unmittelbar während der der Erstellung für jeden, jederzeit frei zugänglich auf einer Webseite im Internet veröffentlicht.
