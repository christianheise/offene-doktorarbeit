...
Um der Entwicklung der Öffnungvon Wissenschaft sowie deren Treiber und Bremser nachgehen zu können, soll eine Onlinebefragung bei den Stakeholdern des akademischen Publizierens explorativ durchgeführt werden, nicht zuletzt weil theoretische Vorannahmen bestehen. Somit soll bereits bestehende Hypothesen getestet, ggf. neue Hypothesen generiert und durch den Vergleich mit der Studie "Neue Formen des Wissenschaftlichen Publizierens" aus dem Jahr 2007 ein Beitrag zur historische Entwicklung erklären wollen. 

Es ist nicht bekannt, ob der damalige Fragebogen auf einer bestimmten Theorie oder
einem Modell basierte, dennoch war das Design der SOFI-Befragung "fächerspezifisch angelegt" \cite{Hanekop_2014}. Es basierte auf einer "Vollerhebung der Wissenschaftler an den Instituten und Einrichtungen an fünf deutschen Standorten, die differenziert nach Fächern, Alters- und Statusgruppen (n=6500) erfasst wurden" \cite{Hanekop_2014}. In die Teilnehmer der Studie wurden anhand von Webseiten der Forschungseinrichtungen identifiziert und per Email zur Teilnahme aufgefordert. 
...
Auf Grund der zunehmenden Verbreitung und Nutzung des Internets, hat die Online-Befragung zunehmend Eingang in die empirische Sozialforschung gefunden \cite{Pannewitz_2002}. Auschlaggebend für die Auswahl dieser Befragungsform ist vor allem die Ökonomie, "die es einfach macht, große Stichproben in kurzer Zeit zu erheben" \cite{eichhorn_2004_online}.
