...
Im Gegensatz zu Open Access gibt es bisher wenige Erklärungen und Statements die eine Annährung an die Definition von Open Science ermöglichen. Demnach kann auch hier die Open Definition als Rahmen dienen, wobei sich Open Science nicht nur auf die fertige wissenschaftliche Publikation, sondern auf den gesamten wissenschaftlichen Erkenntnisprozess. Das stellt auch eine Herausforderung dar, da die unklare Definition des Rahmens, der Wege und der Kriterien zur Folge haben kann, dass auch das genannte Ziel von Open Science verwässert.
