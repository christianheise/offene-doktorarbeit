...
Insgesamt zeichnet diese Fachrichtung aber ein ambivalentes Bild bei dem tatsächlichen Interesse an Offenheit in der eigenen Disziplin. So sind sich die befragten Geisteswissenschaftler über die schleche Zugänglichkeit Ihrer eigenen Beiträge bewusst und bejahten sie die Frage, ob die sie ihre Veröffentlichungen in Zeitschriften oder Büchern für potentielle Leser gut zugänglich befinden am seltensten unter allen Disziplinen. Sie gaben dennoch an, mehrheitlich Interesse an Forschungsdaten anderer zu haben und unterstützen die Idee von Open Access, empfinden Ihe Veröffentlichungen aber als schlecht zugänglich.

Daraus kann man schließen, dass unter den Wissenschaftlern und Wissenschaftlerinnen dieser Fachrichtung das geringste tatsächliche Interesse an Open Access besteht, was verwunderlich ist, denn gerade die Geisteswissenschaften besteht ein hoher Anspruch an die Relevanz und die Verbreitung von Wissen an die Gesamtgesellschaft, auch wenn die wird die Anzahl der Publikationen als überdurchschnittlich wichtiger Faktor für wissenschaftliche Reputation angesehen wird.
