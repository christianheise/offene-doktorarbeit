...
Wie in den vorangegangnene Kapiteln deutlich wurde, sind die Entwicklungen, Definitionen und Debatten um die Öffnung von Wissenschaft und Forschung in der gängigen Literatur weder einheitlich dargestellt, noch unumstritten \cite{muller_2010_open} \cite{schulze_2013_open}. Von hervorzuhebendem Interesse ist im Rahmen der Literaturanalyse der aktuelle Forschungsstand zur Öffnung von Wissenschaft, zu den Treibern und Bremsern dieser Entwicklung und dem damit einhergehenden Wandel mit Fokus auf wissenschaftliche Reputation.

Als Vorgehensweise der Analyse wird die Inhaltsanalyse an die foucaultschen Diskursanalyse angelehnt. Dazu werden aus einem Korpus von ausgewählten Texten die Entwicklungen, Definitionen und Debatten rund um den Themenkomplex der Öffnung von Wissenschaft und Forschung extrahiert und zusammengefasst. Anhand der Ergebnisse die sich mit dem Phänomen Öffnung von Wissenschaft auseinandersetzen, sollen daraufhin weitere wissenschaftliche Fragestellungen für die Befragung von publizierender Wissenschaftler verschiedener Fachbereiche entwickelt werden. Am Ende dieses Kaptitels werden aus den Debatten Treiber und Bremser für die Öffnung von Wissenschaft benannt, für die Befragung extrapoliert und in der Gesamtbetrachtung der Arbeit zusammengeführt und strukturiert ausgewertet.
...
Über die Wirksamkeit und Zweckmäßigkeit des wissenschaftlichen Kommunikationssytems gibt es seit Jahrzehnten Debatten in der Literatur \cite{suchen}. Die immer wieder genannten Herausforderungen am bestehenden System formeller wissenschaftlicher Kommunikation beziehen sich auf zehn Bereiche:
\begin{enumerate}
...
Einen weiterer Aspekt der Debatte um die Herausforderungen betrifft die Geschwindikeit zwischen der Fertigstellung einer wissenschaftlichen Arbeit und deren tatsächlichen Veröffentlichung.

Trotz der Beschleunigung der Prozesse bei der Qualitätssicherung und Bewertung von wissenschaftlichen Arbeiten durch die Digitalisierung der Kommunikation zwischen Wissenschaftlern, Gutachtern und Verlagen, kann es bis zu Jahre dauern, bevor ein Text veröffentlicht wird \cite{suchen}. Diese Verzögerung beruht auf folgenden Umständen:

\begin{enumerate}
\item Gutachter/innen können auf Grund der Ausführung dieser Funktion als Nebentätigkeit meist Termine nicht einhalten\cite{suchen}
\item Es gibt weder Anreiz- noch Saktionierungsmöglichkeiten für Gutacher
\item Die wissenschaftlichen Zeitungen erscheinen größtenteils noch immer als Periodika und sind damit für einen bestimmten Zeitraum der Veröffentlichung terminiert.
\end{enumerate}

Eine Möglichkeit die wissenschaftlichen Inhalte schneller zugägnlich zu machen ohne den sehr zeitaufwändigen Begutachtungsprozess strukturell oder inhaltlich zu verändern ist die Veröffentlichung der wissenschaftlichen Arbeit als Pre-Print. Eine weitere Möglichkeit stellt die offene Begutachtung dar, bei der ein Text anonymisiert veröffentlicht wird und von der wissenschaftlichen Gemeinschaft kollaborativ bewertet wird.

--- Todo: weiter anhand von Literatur ausarbeiten ----

\subsubsection{Freiheit von Wissenschaft und Forschung}

Die Freiheit von Wissenschaft und Forschung, hier insbesondere die Publikationsfreiheit, ist im aktuellen System des wissenschaftlichen Austauschs nicht direkt gefärdet, wird aber durch indirekte Faktoren stark beeinflusst \cite{suchen}.
...
Trotz des eines aufwändigen wissenschafltichen Qualitätssicherungsystems, kommt es immer wieder zu Fehlern und falschen Aussagen in den Veröffentlichungen wissenschaftlicher Ergebnisse.

Um diese Problematik der unzureichenden Fehlerressistenz zu begegnen werden in der Literatur folgende Herangehensweisen genannt:
\begin{enumerate}
...
\item Öffnung der Daten und Methode hinter der Publikation \cite{suchen}
\item umfassende Dokumentation des wissenschaftlichen Wertschöpfungsprozess um Fehler bereits bei der Erstellung der Publikation transparent nachvollziehbar zu machen \cite{suchen}
\end{enumerate}

\subsubsection{Verbreitung und Zugänglichkeit}

Ähnlich wie bei der Frage nach der optimalen Geschwindikeit des aktuellen wissenschaftlichen Kommunikationssystems, stellt sich auch die Frage nach der optimalen Verbreitung und Zugänglichkeit wissenschaftlicher Informationen. Während die Geschwindigkeit auf die zeitliche Komponente von Herstellung bis zum Vertrieb des Wissens abzielt, geht es hier um Verbreitung im Rahmen der Verfügbarkeit des Wissens für eine möglichst große Rezipientengruppe. Wie an vielen Stellen in dieser Arbeit angesprochen, gibt es maßgebliche Zweifel daran, ob es sich bei dem aktuellen System um ein System mit optimalen Vorraussetzungen für die möglichst hohe Verbeitung von Wissen handelt \cite{suchen}.

--- Todo: weiter anhand von Literatur ausarbeiten ----

\subsubsection{Digitalisierung}

Die Digitalisierung der wissenschaftlichen Kommunikation beschränkt sich bisher im größten Teil darauf, dass die analog gedruckten und bewährten Journale, sowie andere Publikationsformen der großen wissenschaftlichen Verlage mit nahezu unverändertem Geschäftsmodell digital verbreitet werden \cite{Hanekop_2014}. Die Möglichkeiten die die Digitalisierung bietet sind damit bei weitem noch nicht ausgeschöpft.

--- Todo: weiter anhand von Literatur ausarbeiten ----

\subsubsection{Reliabilität und Validität}

Die Zuverlässigkeit des Kommunikationssystems kann daran geprüft werden, ob die Einreichung einer Arbeit über unterschiedliche Wege den selben Erfolg hat beziehungsweise, wie stark Zufallsfaktoren auf den Erfolg der Einreichung einwirken. In dem aktuellen System wird diese Replizierbarkeit und Zuverlässigkeit von Ergebnissen stark kritisiert und bezweifelt \cite{suchen}.

--- Todo: weiter anhand von Literatur ausarbeiten ----

\subsubsection{Objektivität und Unabhängigkeit}

Die Kenntnis der Eigenschaften der Autoren seitens der Gutachter stellt eine der größten Herausforderungen für die Wahrung der Objektivität und Unabhängigkeit im wissenschaftlichen Qualitätssicherungsprozess dar. Aber auch bei anderen Formen der Kommunikation kann die Unabhängigkeit nicht gewährleistet werden. In der Literatur finden sich einige Beiträge die sich in diesem Rahmen mit Forschungsförderung beschäftigen und kommen mehrheitlich zu dem Ergebnis, dass die Objektivität und Unabhängigkeit nur schwer bis nicht gesichert werden kann \cite{suchen}.

--- Todo: weiter anhand von Literatur ausarbeiten ----

\subsubsection{Missbrauch}

Von Beginn an stellen in den wissenschaftlichen Debatten die ethischen Grundsätzen von Wissenschaft eine besondere Stellung dar. Eine Grundannahme neben dem Interesse aller Akteure an optimaler Kommunikation zwischen den Wissenschaftlern ist die Erhlichkeit und der Ausschluss von Interessenskonflikten im wissenschaftlichen Wertschöpfungs- und Kommunikationsprozess. So gibt es immer wieder Beispiele für bewussten Missbrauch durch Akteure des Kommunikationssystems um eigene Interessen oder konkreten Einfluss auf wirtschaftliche Aspekte durchzusetzen \cite{suchen}.
...
\textbf{Argumente gegen die Öffnung der wissenschaftlichen Prozesse und Publikationen}
\begin{enumerate}
